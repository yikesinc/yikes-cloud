...
add_action( 'yks_taxonomy_meta_fields', 'add_taxonomy_meta' );

/**
 * Create our Taxonomy Meta boxes.
 *
 * @param array $meta_fields Set our additional metaboxes for taxonomies.
 */
function add_taxonomy_meta( $meta_fields ) {

	// Prefix for all custom fields.
	$prefix = 'category_';

	$meta_fields[] = array(
		'id'       => 'taxonomy_meta_test',
		'taxonomy' => array( 'category', 'post_tag', 'event_categories' ),
		'fields'   => array(
			...
			array(
				...
				'id'   => $prefix . 'text',
				'type' => 'text',
				'desc' => 'This is a description of our text field.',
			),
			array(
			...
			array(
				...
				'dashicon'        => '', // For sortable columns only. Default is 'dashicon-star'.
